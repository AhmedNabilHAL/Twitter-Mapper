...
public class LiveTwitterSource extends TwitterSource {
    ...
    private void initializeTwitterStream() {
        ...
        cb.setOAuthConsumerKey("lGvrXsStbUKOf5SOf1HzIPIrN")
                .setOAuthConsumerSecret("ZItsgKrUku5o5CCpqgzGLojQh1n2Ey9euDGZYdazcau2ku3okB")
                .setOAuthAccessToken("1442316246943363078-rEEdFVPoqsX5bLeGMdqHS6NvxFi4yA")
                .setOAuthAccessTokenSecret("Dt4FqmTpFLlWpH79kgzfCs4fK5vQyL2xjVpcIFmUj2ObH");
